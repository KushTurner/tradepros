...
function NavBar() {
  ...
  return (
    <nav>
      ...
      <ul
        className="font-display m-2 my-7 pt-5 pb-5 p-2 bg-[#121318] rounded-xl md:flex md:space-y-0 md:m-0 md:rounded-none md:py-6 md:text-xl md:p-0 md:items-center md:justify-between"
        hidden={navbarOpen}
      >
        <li
        ...
        <div className="mt-8 flex justify-evenly mx-2 mr-6">
          <li className="navbar-item mr-2 w-full md:ml-0 md:mr-3 p-1 md:mb-0 rounded-lg bg-[#E8E9ED] text-center text-lg font-bold md:px-4">
            <button type="button" className="text-[#5266FE]">
              Sign in
            </button>
          </li>
          <li className="navbar-item ml-2 w-full md:ml-0 md:mr-3 p-1 rounded-lg bg-[#5266FE] text-center text-lg font-bold md:px-4">
            <button type="button" className="text-[#E8E9ED]">
              Register
            </button>
          </li>
        </div>
